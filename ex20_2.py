...
CURRENT_FILE = 1  # Seeks set line count to 0, this makes it 1
print_a_line(CURRENT_FILE, CURRENT_FILE)

CURRENT_FILE = CURRENT_FILE + 1  # Increments line count to 2
print_a_line(CURRENT_FILE, CURRENT_FILE)

CURRENT_FILE = CURRENT_FILE + 1  # Increment line count to 3
print_a_line(CURRENT_FILE, CURRENT_FILE)
